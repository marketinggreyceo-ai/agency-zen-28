...
import {
  ...
  Users, FileText, UserCircle, Shield, LogOut, Search, Target, Menu, Send, Video, MessageCircle, Mic, CalendarClock, Film, BarChart3,
} from "lucide-react";
...
const GROUPS: Group[] = [
  ...
  { id: "work", label: "Работа", items: [
    ...
    { to: "/app/uniquify",     label: "Уникализатор", icon: Film,            page: "uniquify" },
  ]},
  ...
  { id: "system", label: "Система", items: [
    ...
    { to: "/app/voice-access", label: "Доступ к голосу", icon: Mic,             page: "access" },
